...
<body class="animsition">
	...
	<!-- Title page -->
	<section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url('images/return.jpg');">
		...
		<div class="container">
			<div class="row p-b-148">
				<div class="col-md-7 col-lg-8">
					<div class="p-t-7 p-r-85 p-r-15-lg p-r-0-md">
						...
						<p class="stext-113 cl6 p-b-26">
							The Return and Exchange policy of Cozastore is formulated keeping in mind the need and requirement of the local and common people. There is no hidden terms and conditions for this. Everything is written clearly on the website. According to this policy, if you wish to return or exchange any item purchased from cozastore.com, then it should be done within 30 days of the receipt.
      						
						</p>

						<p class="stext-113 cl6 p-b-26">
							Those who return any product, the amount will be credited automatically in the your respective account. It takes around 15 days to get the refund.
						</p>
				</div>
			</div>
				...
				<div class="col-11 col-md-5 col-lg-4 m-lr-auto">
					<div class="how-bor1 ">
						<div class="hov-img0">
							<img src="images/return1.jpg" height="400px" alt="IMG">
						</div>
					</div>
				</div>
			</div>
