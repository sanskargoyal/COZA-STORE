...
if(isset($_REQUEST['submit'])){
	if(($_REQUEST['email'] == "") || ($_REQUEST['msg'] == "")){
		$msg = '<div class="alert alert-danger mt-2" role="alert">Please Fill All Fields.</div>';
	}
	else{
		$email = $_REQUEST['email'];
		$msg = $_REQUEST['msg'];
		$sql = "INSERT INTO contactus(contactus_email, contactus_help) VALUES('$email', '$msg')";
		$result = mysqli_query($conn, $sql);
		if($result == TRUE){
			$msg = '<div class="alert alert-success mt-2" role="alert">Message Submit Successfully.</div>';
			echo '<script>location.href="contact.php"</script>';

		}
		else{
			$msg = '<div class="alert alert-danger mt-2" role="alert">Unable to Submit Message.</div>';
		}
	}
}
	...
	<header class="header-v4">
		...
		<div class="menu-mobile">
			<ul class="topbar-mobile">
				<li>
					<div class="left-top-bar">
						Free shipping for standard order over RS. 00
					</div>
				</li>
				...
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form action="" method="POST">
						...
						<div class="bor8 m-b-30">
							<textarea class="stext-111 cl2 plh3 size-120 p-lr-28 p-tb-25" type="text" name="msg" placeholder="How Can We Help?"></textarea>
						</div>
